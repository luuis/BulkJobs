 ...
 * @author Alumno
 */
@WebServlet(name = "PlanPNuevo", urlPatterns = {"/PlanPNuevo"})
@MultipartConfig
public class PlanPNuevo extends HttpServlet {
            ...
            if(registrarP){
                ...
                try {
                    ...
                    if (fileName.endsWith(".jpg") || fileName.endsWith(".png")) {
                        ...
                        File file = new File(uploads, planP.getIdPlanP()+ ".jpg"); //del contenido creo un archivo(vacio) con ruta y nombre
